...
3. Select **Full-Stack Application** and provide a name of your choice (for example, "CAP") in the upper left corner. 
    ...
    Provide a name. This is the dev space stack you will use for modelling your new app. 
...
11. If you run the "Fiori Preview" on your index page, it is initially empty. Choose "Settings" and configure the colums you want to see.

     Note: This is not a Fiori app, it is a build-in preview functionality.
     
     ![](images/tinysample/2_tiny_dev_6_preview.png)


Your CAP OData service is up and running. It is not yet ready for deployment to Cloud Foundry.
...
This tutorial uses SAP Managed Application Router, which requires a subscription to SAP Build Work Zone service.
...
3. Keep "Managed Approuter" (important) and provide a name for the Approuter. 
